...
class ImageTextData(object):
    ...
    def __init__(self, dataset, root, preprocess, sign, prompt='a picture of a'):
        ...
        #     if prompt:
        #         self.labels = [ prompt + ' ' + x + ' from domain art' for x in self.labels ]
        # elif dataset == './data/OfficeHome/Clipart':
        #     prompt = 'a picture of a'
        #     if prompt:
        #         self.labels = [ prompt + ' ' + x + ' from domain clipart' for x in self.labels ]
        # elif dataset == './data/OfficeHome/Product':
        #     prompt = 'a picture of a'
        #     if prompt:
        #         self.labels = [ prompt + ' ' + x + ' from domain product' for x in self.labels ]
        # elif dataset == './data/OfficeHome/RealWorld':
        #     prompt = 'a picture of a'
        #     if prompt:
        #         self.labels = [ prompt + ' ' + x + ' from domain real world' for x in self.labels ]
        if prompt:
